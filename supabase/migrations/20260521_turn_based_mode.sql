-- ============================================================
-- Turn-based mode: schema additions, submit_turn RPC, process_ticks update
-- ============================================================

ALTER TABLE public.games
  ADD COLUMN IF NOT EXISTS ticks_per_turn       INTEGER DEFAULT 1,
  ADD COLUMN IF NOT EXISTS turn_timeout_minutes INTEGER DEFAULT 1440,
  ADD COLUMN IF NOT EXISTS current_turn_ends_at TIMESTAMPTZ;

ALTER TABLE public.game_players
  ADD COLUMN IF NOT EXISTS turn_submitted    BOOLEAN DEFAULT FALSE,
  ADD COLUMN IF NOT EXISTS turn_submitted_at TIMESTAMPTZ;
